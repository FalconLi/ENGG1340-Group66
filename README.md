...
Features:
  ...
  4. File input is utilized to recive the infomation of the map, the background of the game and so on (requirement4: File input/output).
  5. Games are written in separate files to reduce the difficulty of debugging (requirement5: Program codes in multiple files).
  6. Multithreading method is used to implement uniq input requirements.
